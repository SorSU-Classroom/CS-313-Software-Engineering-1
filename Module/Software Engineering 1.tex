...
\input{C2 - Diagramming for Software Development.tex}

\input{C3 - Low-Fidelity Prototyping with Balsamiq.tex}

\input{C4 - UI-UX Design with Figma.tex}

\input{C5 - Software Development Design Patterns and Principles.tex}

\input{C6 - Fundamentals of Software Quality Assurance (QA).tex}

\input{C7 - API Testing with Postman.tex}

\input{C8 - End-to-End Testing with Playwright.tex}

\input{__References.tex}
